...
class Benchmark {
	...
	*/
	...
	/*
		...
		name: "caching1",
		func: cachingMapV1Creator,
	}, {
		name: "caching2",
		func: cachingMapV2Creator,
	}, {
	*/
		name: "caching3",
		func: cachingMapV3Creator,
	}, {
		name: "fast",
	...
	private static function cachingMapV1Creator():Map.IMap<String, Int> {
		return new CachingStringMapV1<Int>();
	}

	private static function cachingMapV2Creator():Map.IMap<String, Int> {
		return new CachingStringMapV2<Int>();
	}

	private static function cachingMapV3Creator():Map.IMap<String, Int> {
		return new CachingStringMapV3<Int>();
	}
